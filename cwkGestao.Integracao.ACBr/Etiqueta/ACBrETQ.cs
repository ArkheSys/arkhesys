...
namespace cwkGestao.Integracao.ACBr.Etiqueta
{
    public sealed partial class ACBrETQ : ACBrLibHandle
    {
        #region Constructors

        public ACBrETQ(string eArqConfig = "", string eChaveCrypt = "") : base("ACBrETQ32.dll")
        {
        ...
        public void ImprimirQRCode(int vertical, int horizontal, string texto, int larguraModulo, int errorLevel, int tipo)
        {
            ...
            var ret = ExecuteMethod(() => method(libHandle, vertical, horizontal, texto, larguraModulo, errorLevel, tipo));
