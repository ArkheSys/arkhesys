...
namespace cwkGestao.Integracao.ACBr.Balanca
{
    public sealed partial class ACBrBAL : ACBrLibHandle
    {
        ...
        public ACBrBAL(string eArqConfig = "", string eChaveCrypt = "") : base("ACBrBAL32.dll")
        {
        ...
        {
            var method = GetMethod<BAL_ConfigImportar>();
            var ret = ExecuteMethod(() => method(libHandle, ToUTF8(eArqConfig)));
