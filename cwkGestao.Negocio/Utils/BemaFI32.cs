...
namespace FiscalPrinterBematech
{
    ...
    public class BemaFI32
    {
        ...
        {
            string MSG = "";
#pragma warning disable CS0219 // A variável "MSGCaption" é atribuída, mas seu valor nunca é usado
            string MSGCaption = "Atenção";
#pragma warning restore CS0219 // A variável "MSGCaption" é atribuída, mas seu valor nunca é usado
#pragma warning disable CS0219 // A variável "MSGIco" é atribuída, mas seu valor nunca é usado
            MessageBoxIcon MSGIco = MessageBoxIcon.Information;
#pragma warning restore CS0219 // A variável "MSGIco" é atribuída, mas seu valor nunca é usado
            ...
            switch (IRetorno)
            {
                ...
                case -23: MSG = "Não foi possível terminar a Operação!";
                    break;
                case -24: MSG = "Forma de pagamento não programada!";
                    break;
		...
		*/
        ...
        [DllImport("BemaFI32.dll")]
        public static extern int Bematech_FI_VerificaReducaoZAutomatica(ref int Flag);
        ...
        [DllImport("BemaFI32.dll")]
        public static extern int Bematech_FI_DadosSintegra(String DataInicial, String DataFinal);

        [DllImport("BemaFI32.dll")]
        public static extern int Bematech_FI_DadosSintegraMFD(String DataInicial, String DataFinal);

        [DllImport("BemaFI32.dll")]
        public static extern int Bematech_FI_RegistrosTipo60();

        [DllImport("BemaFI32.dll")]
        public static extern int Bematech_FI_RelatorioSintegraMFD(int iRelatorios, string cArquivo, string cMes,
