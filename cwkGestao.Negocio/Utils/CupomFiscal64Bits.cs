...
{
    public class CupomFiscal64Bits : ICupomFiscal
    {
        #region Funções de tratamento de erro
        public void Analisa_RetornoImpressora()
        {
            BemaFI64.Analisa_RetornoImpressora();
        }
        ...
        {
            return BemaFI64.Bematech_FI_AlteraSimboloMoeda(SimboloMoeda);
        }

        public int Bematech_FI_ProgramaAliquota(string Aliquota, int ICMS_ISS)
        {
            return BemaFI64.Bematech_FI_ProgramaAliquota(Aliquota, ICMS_ISS);
        }

        public int Bematech_FI_NomeiaDepartamento(int Indice, string Departamento)
        {
            return BemaFI64.Bematech_FI_NomeiaDepartamento(Indice, Departamento);
        }

        public int Bematech_FI_NomeiaTotalizadorNaoSujeitoIcms(int Indice, string Totalizador)
        {
            return BemaFI64.Bematech_FI_NomeiaTotalizadorNaoSujeitoIcms(Indice, Totalizador);
        }

        public int Bematech_FI_LinhasEntreCupons(int Linhas)
        {
            return BemaFI64.Bematech_FI_LinhasEntreCupons(Linhas);
        }

        public int Bematech_FI_EspacoEntreLinhas(int Dots)
        {
            return BemaFI64.Bematech_FI_EspacoEntreLinhas(Dots);
        }

        public int Bematech_FI_ForcaImpactoAgulhas(int ForcaImpacto)
        {
            return BemaFI64.Bematech_FI_ForcaImpactoAgulhas(ForcaImpacto);
        }

        public int Bematech_FI_ProgramaHorarioVerao()
        {
            return BemaFI64.Bematech_FI_ProgramaHorarioVerao();
        }

        public int Bematech_FI_ProgramaArredondamento()
        {
            return BemaFI64.Bematech_FI_ProgramaArredondamento();
        }

        public int Bematech_FI_ProgramaTruncamento()
        {
            return BemaFI64.Bematech_FI_ProgramaTruncamento();
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_AbreCupom(CGC_CPF);
        }
        ...
        {
            return BemaFI64.Bematech_FI_VendeItem(Codigo, Descricao, Aliquota, TipoQuantidade, Quantidade, CasasDecimais, ValorUnitario, TipoDesconto, Desconto);
        }
        ...
        {
            return BemaFI64.Bematech_FI_VendeItemDepartamento(Codigo, Descricao, Aliquota, ValorUnitario, Quantidade, Acrescimo, Desconto, IndiceDepartamento, UnidadeMedida);
        }

        public int Bematech_FI_CancelaItemAnterior()
        {
            return BemaFI64.Bematech_FI_CancelaItemAnterior();
        }

        public int Bematech_FI_CancelaItemGenerico(string NumeroItem)
        {
            return BemaFI64.Bematech_FI_CancelaItemGenerico(NumeroItem);
        }

        public int Bematech_FI_CancelaCupom()
        {
            return BemaFI64.Bematech_FI_CancelaCupom();
        }

        public int Bematech_FI_FechaCupomResumido(string FormaPagamento, string Mensagem)
        {
            return BemaFI64.Bematech_FI_FechaCupomResumido(FormaPagamento, Mensagem);
        }
        ...
        {
            return BemaFI64.Bematech_FI_FechaCupom(FormaPagamento, AcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto, ValorPago, Mensagem);
        }
        ...
        {
            return BemaFI64.Bematech_FI_IniciaFechamentoCupom(AcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto);
        }

        public int Bematech_FI_EfetuaFormaPagamento(string FormaPagamento, string ValorFormaPagamento)
        {
            return BemaFI64.Bematech_FI_EfetuaFormaPagamento(FormaPagamento, ValorFormaPagamento);
        }
        ...
        {
            return BemaFI64.Bematech_FI_EfetuaFormaPagamentoDescricaoForma(FormaPagamento, ValorFormaPagamento, Descricao);
        }

        public int Bematech_FI_TerminaFechamentoCupom(string Mensagem)
        {
            return BemaFI64.Bematech_FI_TerminaFechamentoCupom(Mensagem);
        }

        public int Bematech_FI_EstornoFormasPagamento(string FormaOrigem, string FormaDestino, string Valor)
        {
            return BemaFI64.Bematech_FI_EstornoFormasPagamento(FormaOrigem, FormaDestino, Valor);
        }

        public int Bematech_FI_AumentaDescricaoItem(string Descricao)
        {
            return BemaFI64.Bematech_FI_AumentaDescricaoItem(Descricao);
        }

        public int Bematech_FI_UsaUnidadeMedida(string UnidadeMedida)
        {
            return BemaFI64.Bematech_FI_UsaUnidadeMedida(UnidadeMedida);
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_RecebimentoNaoFiscal(IndiceTotalizador, Valor, FormaPagamento);
        }

        public int Bematech_FI_AbreComprovanteNaoFiscalVinculado(string FormaPagamento, string Valor, string NumeroCupom)
        {
            return BemaFI64.Bematech_FI_AbreComprovanteNaoFiscalVinculado(FormaPagamento, Valor, NumeroCupom);
        }

        public int Bematech_FI_UsaComprovanteNaoFiscalVinculado(string Texto)
        {
            return BemaFI64.Bematech_FI_UsaComprovanteNaoFiscalVinculado(Texto);
        }

        public int Bematech_FI_FechaComprovanteNaoFiscalVinculado()
        {
            return BemaFI64.Bematech_FI_FechaComprovanteNaoFiscalVinculado();
        }

        public int Bematech_FI_Sangria(string Valor)
        {
            return BemaFI64.Bematech_FI_Sangria(Valor);
        }

        public int Bematech_FI_Suprimento(string Valor, string FormaPagamento)
        {
            return BemaFI64.Bematech_FI_Suprimento(Valor, FormaPagamento);
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_Acrescimos(ref ValorAcrescimos);
        }

        public int Bematech_FI_Cancelamentos([MarshalAs(UnmanagedType.VBByRefStr)] ref string ValorCancelamentos)
        {
            return BemaFI64.Bematech_FI_Cancelamentos(ref ValorCancelamentos);
        }
        ...
        {
            return BemaFI64.Bematech_FI_DataHoraImpressora(ref Data, ref Hora);
        }
        ...
        {
            return BemaFI64.Bematech_FI_Autenticacao();
        }

        public int Bematech_FI_ProgramaCaracterAutenticacao(string Parametros)
        {
            return BemaFI64.Bematech_FI_ProgramaCaracterAutenticacao(Parametros);
        }

        public int Bematech_FI_AcionaGaveta()
        {
            return BemaFI64.Bematech_FI_AcionaGaveta();
        }

        public int Bematech_FI_VerificaEstadoGaveta(out int EstadoGaveta)
        {
            return BemaFI64.Bematech_FI_VerificaEstadoGaveta(out EstadoGaveta);
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_CancelaImpressaoCheque();
        }
        ...
        {
            return BemaFI64.Bematech_FI_ImprimeCheque(Banco, Valor, Favorecido, Cidade, Data, Mensagem);
        }

        public int Bematech_FI_ImprimeCopiaCheque()
        {
            return BemaFI64.Bematech_FI_ImprimeCopiaCheque();
        }

        public int Bematech_FI_IncluiCidadeFavorecido(string Cidade, string Favorecido)
        {
            return BemaFI64.Bematech_FI_IncluiCidadeFavorecido(Cidade, Favorecido);
        }

        public int Bematech_FI_ProgramaMoedaPlural(string MoedaPlural)
        {
            return BemaFI64.Bematech_FI_ProgramaMoedaPlural(MoedaPlural);
        }

        public int Bematech_FI_ProgramaMoedaSingular(string MoedaSingular)
        {
            return BemaFI64.Bematech_FI_ProgramaMoedaSingular(MoedaSingular);
        }

        public int Bematech_FI_VerificaStatusCheque(ref int StatusCheque)
        {
            return BemaFI64.Bematech_FI_VerificaStatusCheque(ref StatusCheque);
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_AberturaDoDia(Valor, FormaPagto);
        }

        public int Bematech_FI_AbrePortaSerial()
        {
            return BemaFI64.Bematech_FI_AbrePortaSerial();
        }

        public int Bematech_FI_FechamentoDoDia()
        {
            return BemaFI64.Bematech_FI_FechamentoDoDia();
        }

        public int Bematech_FI_FechaPortaSerial()
        {
            return BemaFI64.Bematech_FI_FechaPortaSerial();
        }

        public int Bematech_FI_ImprimeDepartamentos()
        {
            return BemaFI64.Bematech_FI_ImprimeDepartamentos();
        }

        public int Bematech_FI_MapaResumo()
        {
            return BemaFI64.Bematech_FI_MapaResumo();
        }

        public int Bematech_FI_RelatorioTipo60Analitico()
        {
            return BemaFI64.Bematech_FI_RelatorioTipo60Analitico();
        }

        public int Bematech_FI_RelatorioTipo60Mestre()
        {
            return BemaFI64.Bematech_FI_RelatorioTipo60Mestre();
        }

        public int Bematech_FI_RetornoImpressora(ref int ACK, ref int ST1, ref int ST2)
        {
            return BemaFI64.Bematech_FI_RetornoImpressora(ref ACK, ref ST1, ref ST2);
        }

        public int Bematech_FI_VerificaImpressoraLigada()
        {
            return BemaFI64.Bematech_FI_VerificaImpressoraLigada();
        }

        public int Bematech_FI_ResetaImpressora()
        {
            return BemaFI64.Bematech_FI_ResetaImpressora();
        }
        ...
        {
            return BemaFI64.Bematech_FI_AbreBilhetePassagem(ImprimeValorFinal, ImprimeEnfatizado, Embarque, Destino, Linha, Prefixo, Agente, Agencia, Data, Hora, Poltrona, Plataforma);
        }
        ...
        {
            return BemaFI64.Bematech_FI_ImpressaoCarne(Titulo, Parcelas, Datas, Quantidade, Texto, Cliente, RG_CPF, Cupom, Vias, Assina);
        }

        public int Bematech_FI_DadosSintegra(String DataInicial, String DataFinal)
        {
            return BemaFI64.Bematech_FI_DadosSintegra(DataInicial, DataFinal);
        }

        public int Bematech_FI_DadosSintegraMFD(String DataInicial, String DataFinal)
        {
            return BemaFI64.Bematech_FI_DadosSintegraMFD(DataInicial, DataFinal);
        }

        public int Bematech_FI_RegistrosTipo60()
        {
            return BemaFI64.Bematech_FI_RegistrosTipo60();
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FIR_AbreConferenciaMesa(Mesa);
        }

        public int Bematech_FIR_AbreCupomRestaurante(string Mesa, string CGC_CPF)
        {
            return BemaFI64.Bematech_FIR_AbreCupomRestaurante(Mesa, CGC_CPF);
        }
        ...
        {
            return BemaFI64.Bematech_FIR_CancelaVenda(Mesa, Codigo, Descricao, Aliquota, Quantidade, ValorUnitario, FlagAcrescimoDesconto, ValorAcrescimoDesconto);
        }
        ...
        {
            return BemaFI64.Bematech_FIR_ConferenciaMesa(Mesa, FlagAcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto);
        }

        public int Bematech_FIR_ContaDividida(string NumeroCupons, string ValorPago, string CGC_CPF)
        {
            return BemaFI64.Bematech_FIR_ContaDividida(NumeroCupons, ValorPago, CGC_CPF);
        }

        public int Bematech_FIR_CardapioPelaSerial()
        {
            return BemaFI64.Bematech_FIR_CardapioPelaSerial();
        }
        ...
        {
            return BemaFI64.Bematech_FIR_FechaConferenciaMesa(FlagAcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto);
        }
        ...
        {
            return BemaFI64.Bematech_FIR_FechaCupomContaDividida(NumeroCupons, FlagAcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto, FormasPagamento, ValorFormasPagamento, ValorPagoCliente, CGC_CPF);
        }
        ...
        {
            return BemaFI64.Bematech_FIR_FechaCupomRestaurante(FormaPagamento, FlagAcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto, ValorFormaPagto, Mensagem);
        }

        public int Bematech_FIR_ImprimeCardapio()
        {
            return BemaFI64.Bematech_FIR_ImprimeCardapio();
        }
        ...
        {
            return BemaFI64.Bematech_FIR_RegistraVenda(Mesa, Codigo, Descricao, Aliquota, Quantidade, ValorUnitario, FlagAcrescimoDesconto, ValorAcrescimoDesconto);
        }

        public int Bematech_FIR_RegistroVendaSerial(string Mesa)
        {
            return BemaFI64.Bematech_FIR_RegistroVendaSerial(Mesa);
        }

        public int Bematech_FIR_RelatorioMesasAbertas(int TipoRelatorio)
        {
            return BemaFI64.Bematech_FIR_RelatorioMesasAbertas(TipoRelatorio);
        }

        public int Bematech_FIR_RelatorioMesasAbertasSerial()
        {
            return BemaFI64.Bematech_FIR_RelatorioMesasAbertasSerial();
        }
        ...
        {
            return BemaFI64.Bematech_FIR_TransferenciaItem(MesaOrigem, Codigo, Descricao, Aliquota, Quantidade, ValorUnitario, FlagAcrescimoDesconto, ValorAcrescimoDesconto, MesaDestino);
        }

        public int Bematech_FIR_TransferenciaMesa(string MesaOrigem, string MesaDestino)
        {
            return BemaFI64.Bematech_FIR_TransferenciaMesa(MesaOrigem, MesaDestino);
        }

        public int Bematech_FIR_VerificaMemoriaLivre(string Bytes)
        {
            return BemaFI64.Bematech_FIR_VerificaMemoriaLivre(Bytes);
        }

        public int Bematech_FIR_FechaCupomResumidoRestaurante(string FormaPagamento, string Mensagem)
        {
            return BemaFI64.Bematech_FIR_FechaCupomResumidoRestaurante(FormaPagamento, Mensagem);
        }
        #endregion
        ...
        {
            return BemaFI64.Bematech_FI_AbreBilhetePassagemMFD(Embarque, Destino, Linha, Agencia, Data, Hora, Poltrona, Plataforma, TipoPassagem);
        }
        ...
        {
            return BemaFI64.Bematech_FI_AbreComprovanteNaoFiscalVinculadoMFD(FormaPagamento, Valor, NumeroCupom, CGC, nome, Endereco);
        }

        public int Bematech_FI_AbreCupomMFD(string CGC, string Nome, string Endereco)
        {
            return BemaFI64.Bematech_FI_AbreCupomMFD(CGC, Nome, Endereco);
        }

        public int Bematech_FI_AbreRecebimentoNaoFiscalMFD(string CGC, string Nome, string Endereco)
        {
            return BemaFI64.Bematech_FI_AbreRecebimentoNaoFiscalMFD(CGC, Nome, Endereco);
        }

        public int Bematech_FI_AbreRelatorioGerencialMFD(string Indice)
        {
            return BemaFI64.Bematech_FI_AbreRelatorioGerencialMFD(Indice);
        }
        ...
        {
            return BemaFI64.Bematech_FI_AcrescimoDescontoItemMFD(Item, AcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimoDesconto);
        }

        public int Bematech_FI_AcrescimoDescontoSubtotalRecebimentoMFD(string cFlag, string cTipo, string cValor)
        {
            return BemaFI64.Bematech_FI_AcrescimoDescontoSubtotalRecebimentoMFD(cFlag, cTipo, cValor);
        }

        public int Bematech_FI_AcrescimoDescontoSubtotalMFD(string cFlag, string cTipo, string cValor)
        {
            return BemaFI64.Bematech_FI_AcrescimoDescontoSubtotalMFD(cFlag, cTipo, cValor);
        }

        public int Bematech_FI_AutenticacaoMFD(string Linhas, string Texto)
        {
            return BemaFI64.Bematech_FI_AutenticacaoMFD(Linhas, Texto);
        }

        public int Bematech_FI_CancelaAcrescimoDescontoItemMFD(string cFlag, string cItem)
        {
            return BemaFI64.Bematech_FI_CancelaAcrescimoDescontoItemMFD(cFlag, cItem);
        }

        public int Bematech_FI_CancelaAcrescimoDescontoSubtotalMFD(string cFlag)
        {
            return BemaFI64.Bematech_FI_CancelaAcrescimoDescontoSubtotalMFD(cFlag);
        }

        public int Bematech_FI_CancelaAcrescimoDescontoSubtotalRecebimentoMFD(string cFlag)
        {
            return BemaFI64.Bematech_FI_CancelaAcrescimoDescontoSubtotalRecebimentoMFD(cFlag);
        }

        public int Bematech_FI_CancelaCupomMFD(string CGC, string Nome, string Endereco)
        {
            return BemaFI64.Bematech_FI_CancelaCupomMFD(CGC, Nome, Endereco);
        }

        public int Bematech_FI_CancelaRecebimentoNaoFiscalMFD(string CGC, string Nome, string Endereco)
        {
            return BemaFI64.Bematech_FI_CancelaRecebimentoNaoFiscalMFD(CGC, Nome, Endereco);
        }

        public int Bematech_FI_ComprovantesNaoFiscaisNaoEmitidosMFD(string Comprovantes)
        {
            return BemaFI64.Bematech_FI_ComprovantesNaoFiscaisNaoEmitidosMFD(Comprovantes);
        }

        public int Bematech_FI_CNPJMFD(string CNPJ)
        {
            return BemaFI64.Bematech_FI_CNPJMFD(CNPJ);
        }

        public int Bematech_FI_ContadorComprovantesCreditoMFD(string Comprovantes)
        {
            return BemaFI64.Bematech_FI_ContadorComprovantesCreditoMFD(Comprovantes);
        }

        public int Bematech_FI_ContadorCupomFiscalMFD(string CuponsEmitidos)
        {
            return BemaFI64.Bematech_FI_ContadorCupomFiscalMFD(CuponsEmitidos);
        }

        public int Bematech_FI_ContadorFitaDetalheMFD(string ContadorFita)
        {
            return BemaFI64.Bematech_FI_ContadorFitaDetalheMFD(ContadorFita);
        }

        public int Bematech_FI_ContadorOperacoesNaoFiscaisCanceladasMFD(string OperacoesCanceladas)
        {
            return BemaFI64.Bematech_FI_ContadorOperacoesNaoFiscaisCanceladasMFD(OperacoesCanceladas);
        }

        public int Bematech_FI_ContadorRelatoriosGerenciaisMFD(string Relatorios)
        {
            return BemaFI64.Bematech_FI_ContadorRelatoriosGerenciaisMFD(Relatorios);
        }

        public int Bematech_FI_ContadoresTotalizadoresNaoFiscaisMFD(string Contadores)
        {
            return BemaFI64.Bematech_FI_ContadoresTotalizadoresNaoFiscaisMFD(Contadores);
        }

        public int Bematech_FI_CupomAdicionalMFD()
        {
            return BemaFI64.Bematech_FI_CupomAdicionalMFD();
        }

        public int Bematech_FI_DadosUltimaReducaoMFD(string DadosReducao)
        {
            return BemaFI64.Bematech_FI_DadosUltimaReducaoMFD(DadosReducao);
        }

        public int Bematech_FI_DataHoraUltimoDocumentoMFD(string cDataHora)
        {
            return BemaFI64.Bematech_FI_DataHoraUltimoDocumentoMFD(cDataHora);
        }
        ...
        {
            return BemaFI64.Bematech_FI_EfetuaFormaPagamentoMFD(FormaPagamento, ValorFormaPagamento, Parcelas, DescricaoFormaPagto);
        }

        public int Bematech_FI_EfetuaRecebimentoNaoFiscalMFD(string IndiceTotalizador, string ValorRecebimento)
        {
            return BemaFI64.Bematech_FI_EfetuaRecebimentoNaoFiscalMFD(IndiceTotalizador, ValorRecebimento);
        }

        public int Bematech_FI_EstornoNaoFiscalVinculadoMFD(string CGC, string Nome, string Endereco)
        {
            return BemaFI64.Bematech_FI_EstornoNaoFiscalVinculadoMFD(CGC, Nome, Endereco);
        }

        public int Bematech_FI_FechaRecebimentoNaoFiscalMFD(string Mensagem)
        {
            return BemaFI64.Bematech_FI_FechaRecebimentoNaoFiscalMFD(Mensagem);
        }

        public int Bematech_FI_HabilitaDesabilitaRetornoEstendidoMFD(string FlagRetorno)
        {
            return BemaFI64.Bematech_FI_HabilitaDesabilitaRetornoEstendidoMFD(FlagRetorno);
        }
        ...
        {
            return BemaFI64.Bematech_FI_ImprimeChequeMFD(NumeroBanco, Valor, Favorecido, Cidade, Data, Mensagem, ImpressaoVerso, Linhas);
        }
        ...
        {
            return BemaFI64.Bematech_FI_IniciaFechamentoCupomMFD(AcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimo, ValorDesconto);
        }
        ...
        {
            return BemaFI64.Bematech_FI_IniciaFechamentoRecebimentoNaoFiscalMFD(AcrescimoDesconto, TipoAcrescimoDesconto, ValorAcrescimo, ValorDesconto);
        }

        public int Bematech_FI_InscricaoEstadualMFD(string InscricaoEstadual)
        {
            return BemaFI64.Bematech_FI_InscricaoEstadualMFD(InscricaoEstadual);
        }

        public int Bematech_FI_InscricaoMunicipalMFD(string InscricaoMunicipal)
        {
            return BemaFI64.Bematech_FI_InscricaoMunicipalMFD(InscricaoMunicipal);
        }

        public int Bematech_FI_LeituraChequeMFD(string CodigoCMC7)
        {
            return BemaFI64.Bematech_FI_LeituraChequeMFD(CodigoCMC7);
        }

        public int Bematech_FI_LeituraMemoriaFiscalDataMFD(string DataInicial, string DataFinal, string FlagLeitura)
        {
            return BemaFI64.Bematech_FI_LeituraMemoriaFiscalDataMFD(DataInicial, DataFinal, FlagLeitura);
        }

        public int Bematech_FI_LeituraMemoriaFiscalReducaoMFD(string ReducaoInicial, string ReducaoFinal, string FlagLeitura)
        {
            return BemaFI64.Bematech_FI_LeituraMemoriaFiscalReducaoMFD(ReducaoInicial, ReducaoFinal, FlagLeitura);
        }

        public int Bematech_FI_LeituraMemoriaFiscalSerialDataMFD(string DataInicial, string DataFinal, string FlagLeitura)
        {
            return BemaFI64.Bematech_FI_LeituraMemoriaFiscalSerialDataMFD(DataInicial, DataFinal, FlagLeitura);
        }

        public int Bematech_FI_LeituraMemoriaFiscalSerialReducaoMFD(string ReducaoInicial, string ReducaoFinal, string FlagLeitura)
        {
            return BemaFI64.Bematech_FI_LeituraMemoriaFiscalSerialReducaoMFD(ReducaoInicial, ReducaoFinal, FlagLeitura);
        }

        public int Bematech_FI_MapaResumoMFD()
        {
            return BemaFI64.Bematech_FI_MapaResumoMFD();
        }

        public int Bematech_FI_MarcaModeloTipoImpressoraMFD(string Marca, string Modelo, string Tipo)
        {
            return BemaFI64.Bematech_FI_MarcaModeloTipoImpressoraMFD(Marca, Modelo, Tipo);
        }

        public int Bematech_FI_MinutosEmitindoDocumentosFiscaisMFD(string Minutos)
        {
            return BemaFI64.Bematech_FI_MinutosEmitindoDocumentosFiscaisMFD(Minutos);
        }

        public int Bematech_FI_NomeiaRelatorioGerencialMFD(string Indice, string Descricao)
        {
            return BemaFI64.Bematech_FI_NomeiaRelatorioGerencialMFD(Indice, Descricao);
        }

        public int Bematech_FI_NumeroSerieMFD(string NumeroSerie)
        {
            return BemaFI64.Bematech_FI_NumeroSerieMFD(NumeroSerie);
        }

        public int Bematech_FI_NumeroSerieMemoriaMFD(string NumeroSerieMFD)
        {
            return BemaFI64.Bematech_FI_NumeroSerieMemoriaMFD(NumeroSerieMFD);
        }

        public int Bematech_FI_PercentualLivreMFD(string cMemoriaLivre)
        {
            return BemaFI64.Bematech_FI_PercentualLivreMFD(cMemoriaLivre);
        }

        public int Bematech_FI_ProgramaFormaPagamentoMFD(string FormaPagto, string OperacaoTef)
        {
            return BemaFI64.Bematech_FI_ProgramaFormaPagamentoMFD(FormaPagto, OperacaoTef);
        }

        public int Bematech_FI_ReducoesRestantesMFD(string Reducoes)
        {
            return BemaFI64.Bematech_FI_ReducoesRestantesMFD(Reducoes);
        }

        public int Bematech_FI_ReimpressaoNaoFiscalVinculadoMFD()
        {
            return BemaFI64.Bematech_FI_ReimpressaoNaoFiscalVinculadoMFD();
        }

        public int Bematech_FI_RelatorioTipo60AnaliticoMFD()
        {
            return BemaFI64.Bematech_FI_RelatorioTipo60AnaliticoMFD();
        }

        public int Bematech_FI_RetornoImpressoraMFD(ref int ACK, ref int ST1, ref int ST2, ref int ST3)
        {
            return BemaFI64.Bematech_FI_RetornoImpressoraMFD(ref ACK, ref ST1, ref ST2, ref ST3);
        }

        public int Bematech_FI_SegundaViaNaoFiscalVinculadoMFD()
        {
            return BemaFI64.Bematech_FI_SegundaViaNaoFiscalVinculadoMFD();
        }

        public int Bematech_FI_SubTotalizaCupomMFD()
        {
            return BemaFI64.Bematech_FI_SubTotalizaCupomMFD();
        }

        public int Bematech_FI_SubTotalizaRecebimentoMFD()
        {
            return BemaFI64.Bematech_FI_SubTotalizaRecebimentoMFD();
        }

        public int Bematech_FI_TotalLivreMFD(string cMemoriaLivre)
        {
            return BemaFI64.Bematech_FI_TotalLivreMFD(cMemoriaLivre);
        }

        public int Bematech_FI_TamanhoTotalMFD(string cTamanhoMFD)
        {
            return BemaFI64.Bematech_FI_TamanhoTotalMFD(cTamanhoMFD);
        }

        public int Bematech_FI_TempoOperacionalMFD(string TempoOperacional)
        {
            return BemaFI64.Bematech_FI_TempoOperacionalMFD(TempoOperacional);
        }

        public int Bematech_FI_TotalizaCupomMFD()
        {
            return BemaFI64.Bematech_FI_TotalizaCupomMFD();
        }

        public int Bematech_FI_TotalizaRecebimentoMFD()
        {
            return BemaFI64.Bematech_FI_TotalizaRecebimentoMFD();
        }

        public int Bematech_FI_UsaRelatorioGerencialMFD(string Texto)
        {
            return BemaFI64.Bematech_FI_UsaRelatorioGerencialMFD(Texto);
        }

        public int Bematech_FI_ValorFormaPagamentoMFD(string Forma, string ValorForma)
        {
            return BemaFI64.Bematech_FI_ValorFormaPagamentoMFD(Forma, ValorForma);
        }

        public int Bematech_FI_ValorTotalizadorNaoFiscalMFD(string Totalizador, string ValorTotalizador)
        {
            return BemaFI64.Bematech_FI_ValorTotalizadorNaoFiscalMFD(Totalizador, ValorTotalizador);
        }

        public int Bematech_FI_VerificaEstadoImpressoraMFD(ref int ACK, ref int ST1, ref int ST2, ref int ST3)
        {
            return BemaFI64.Bematech_FI_VerificaEstadoImpressoraMFD(ref ACK, ref ST1, ref ST2, ref ST3);
        }

        public int Bematech_FI_VerificaFormasPagamentoMFD(string FormasPagamento)
        {
            return BemaFI64.Bematech_FI_VerificaFormasPagamentoMFD(FormasPagamento);
        }

        public int Bematech_FI_VerificaRecebimentoNaoFiscalMFD(string Recebimentos)
        {
            return BemaFI64.Bematech_FI_VerificaRecebimentoNaoFiscalMFD(Recebimentos);
        }

        public int Bematech_FI_VerificaRelatorioGerencialMFD(string Relatorios)
        {
            return BemaFI64.Bematech_FI_VerificaRelatorioGerencialMFD(Relatorios);
        }

        public int Bematech_FI_VerificaTotalizadoresNaoFiscaisMFD(string Totalizadores)
        {
            return BemaFI64.Bematech_FI_VerificaTotalizadoresNaoFiscaisMFD(Totalizadores);
        }

        public int Bematech_FI_VerificaTotalizadoresParciaisMFD(string Totalizadores)
        {
            return BemaFI64.Bematech_FI_VerificaTotalizadoresParciaisMFD(Totalizadores);
        }

        public int Bematech_FI_VersaoFirmwareMFD(string VersaoFirmware)
        {
            return BemaFI64.Bematech_FI_VersaoFirmwareMFD(VersaoFirmware);
        }
        ...
        {
             return  BemaFI64.Bematech_FI_RelatorioSintegraMFD(iRelatorios, Arquivo, Mes,
