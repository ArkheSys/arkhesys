...
{
    public partial class XtraRelatorioProdutosPorDataValidade : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraRelatorioProdutosPorDataValidade()
        {
            InitializeComponent();
        }

        public XtraRelatorioProdutosPorDataValidade(string Empresa)
        {
            InitializeComponent();
