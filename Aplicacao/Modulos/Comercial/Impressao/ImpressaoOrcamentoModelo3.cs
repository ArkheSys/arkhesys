...
{
    public class ImpressaoOrcamentoModelo3 : ImpressaoOrcamento
    {
        public string Email;
        ...
        public ImpressaoOrcamentoModelo3(cwkGestao.Modelo.Pedido objPedido) : base(objPedido) { }

        public override void Imprimir()
        {
            DestinoImpressao = new Aplicacao.DestinoImpressaoPedido().ShowDialog();
            rptImpressaoNota02 rpt = new rptImpressaoNota02(objPedido.ID);
