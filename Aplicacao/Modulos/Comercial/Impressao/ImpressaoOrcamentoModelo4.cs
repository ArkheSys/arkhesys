...
{
    public class ImpressaoOrcamentoModelo4 : ImpressaoOrcamento
    {
        public string Email;
        ...
        public ImpressaoOrcamentoModelo4(cwkGestao.Modelo.Pedido objPedido) : base(objPedido) { }

        public override void Imprimir()
        {
            DestinoImpressao = new Aplicacao.DestinoImpressaoPedido().ShowDialog();
            rptImpressaoNota03 rpt = new rptImpressaoNota03(objPedido.ID, ConfiguracaoController.Instancia.GetConfiguracao().ObservacaoNoItemPedido == 1);
            ...
            try
            {
                switch (DestinoImpressao)
                {
                    ...
                    case DestinoImpressao.Email:
                        bool podeEnviar = ColetarDadosEmail(new ImpressaoOrcamentoModelo4(objPedido),objPedido);
        ...
        public bool ColetarDadosEmail(ImpressaoOrcamentoModelo4 Impressao, Pedido pedido)
        {
