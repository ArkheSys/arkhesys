...
{
    public partial class XRReportFluxoCaixa_SuprimentosA4 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRReportFluxoCaixa_SuprimentosA4()
        {
            InitializeComponent();
        }

        public XRReportFluxoCaixa_SuprimentosA4(List<SuprimentoCaixa> Suprimentos)
        {
            InitializeComponent();
