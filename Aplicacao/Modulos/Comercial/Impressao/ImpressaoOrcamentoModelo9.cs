...
{
    public class ImpressaoOrcamentoModelo9 : ImpressaoOrcamento
    {
        public string Email;
        public string ObservacaoEmail;
        public DestinoImpressao DestinoImpressao;
        public bool EnvioEmailCancelado = false;
        public ImpressaoOrcamentoModelo9(cwkGestao.Modelo.Pedido objPedido) : base(objPedido) { }

        public override void Imprimir()
        {
            DestinoImpressao = new Aplicacao.DestinoImpressaoPedido().ShowDialog();
            rptImpressaoPedido09 rpt = new rptImpressaoPedido09(objPedido.ID);
