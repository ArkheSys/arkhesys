        ...
        private static ImpressaoOrcamento GetImpressaoGrafica(Pedido pedido)
        {
            ...
            if (pedido.TipoPedido.Ent_Sai == 2)
            {
                switch (config.ModeloImpressaoGrafica)
                {
                    ...
                    case ModeloImpressaoGraficaType.Modelo8:
                        return new ImpressaoOrcamentoModelo8(pedido);
                    case ModeloImpressaoGraficaType.Modelo9:
                        return new ImpressaoOrcamentoModelo9(pedido);
                }
            }
            else
            {
