    ...
    public class ImpressaoOrcamentoMeiaFolha : ImpressaoOrcamento
    {
        ...
        private void ReparteQtdProdutos(Int32 ID)
        {
            ...
            while (dr.Read())
            {
                ...
                {
                    GeraRelatorio(DadosParciais, dr.GetInt32(pCodigoPedido));
        ...
        private void GeraRelatorio(Relatorio.dsImpressaoOrdemServico.RelOrcamentoDataTable Dados, int a)
        {
            ...
            var Ped = PedidoController.Instancia.GetByCodigo(a);
            rptOrcamentoMeiaFolha form = new rptOrcamentoMeiaFolha(Ped?.Observacao1 ?? "") { DataSource = dataSet };
