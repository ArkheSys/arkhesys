...
{
    public partial class XRReportFluxoCaixa_BaixasRecebidasA4 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRReportFluxoCaixa_BaixasRecebidasA4()
        {
            InitializeComponent();
        }

        public XRReportFluxoCaixa_BaixasRecebidasA4(int IDFluxoCaixa)
        {
            InitializeComponent();
