...
namespace Aplicacao.Modulos.Comercial.Impressao
{
    public class ImpressaoOrcamentoJatoTinta : ImpressaoOrcamento
    {
        ...
        private List<Microsoft.Reporting.WinForms.ReportParameter> GetParametros()
        {
            ...
            parametros.Add(new ReportParameter("img", objPedido.Filial.CaminhoLogoEmpresa)); //  global::Modelo.cwkGlobal.DirApp + @"\LogoEmpresa.jpg")
...
#pragma warning disable CS0108 // "ImpressaoOrcamentoJatoTinta.SetPercentualDesconto()" oculta o membro herdado "ImpressaoOrcamento.SetPercentualDesconto()". Use a nova palavra-chave se foi pretendido ocultar.
        private void SetPercentualDesconto()
#pragma warning restore CS0108 // "ImpressaoOrcamentoJatoTinta.SetPercentualDesconto()" oculta o membro herdado "ImpressaoOrcamento.SetPercentualDesconto()". Use a nova palavra-chave se foi pretendido ocultar.
        {
        ...
        private void SetNomeRelatorio()
        {
            ...
            */
            ...
            nomerel = string.IsNullOrEmpty(objPedido.TipoPedido.NomeRelatorio) ? "rptImpressaoNota" : objPedido.TipoPedido.NomeRelatorio;
        ...
        private void GeraRelatorio()
        {
            ...
            if (nomerel != "rptImpressaoNotaRetratoAgalux.rdlc")
            {
                for (int i = 0; i < Dados.Count; i++)
                {
                    ...
                    if (ConfiguracaoController.Instancia.GetConfiguracao().ObservacaoNoItemPedido == 1)
                        Dados[i]["ObservacaoPedido"] = "";
                }
