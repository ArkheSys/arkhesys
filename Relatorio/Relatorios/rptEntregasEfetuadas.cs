...
{
    public partial class rptEntregasEfetuadas : DevExpress.XtraReports.UI.XtraReport
    {
        public rptEntregasEfetuadas(DateTime dtInicio, DateTime dtFim, string IDPedido)
        {
            InitializeComponent();

            entregasEfetuadasTableAdapter.GetData(dtInicio, dtFim, IDPedido);
