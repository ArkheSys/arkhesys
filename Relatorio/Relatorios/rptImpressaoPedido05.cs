...
{
    public partial class rptImpressaoPedido05 : DevExpress.XtraReports.UI.XtraReport
    {
        public rptImpressaoPedido05(int PedidoID)
        {
            InitializeComponent();

            pedido05TableAdapter.GetData(PedidoID);
